...
public class PropertyDetails extends Properties {
    ...
    public PropertyDetails(String name, Group group, int price, int rent, int rent1, int rent2, int rent3, int rent4, int rentH){
